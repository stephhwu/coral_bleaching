...
After researching for supplemental data to support our project topic, we found that the Smithsonian and the NOAA announced a new memorandum of understanding at the beginning of this year aimed at enhancing collaborative efforts to understand and conserve ocean biodiversity.

With that in mind, we were able to find data on coral bleaching in 5 jurisdictions within the Pacific Ocean sourced from NOAA along with time series data for these regions.
...
The row of images displays a progression from the least to the most bleaching recorded in that year. Hovering over an image reveals the bleaching prevalence and highlights changes in monitored genera over time.
...
Explore the project and source code on [GitHub](https://stephhwu.github.io/coral_bleaching/coral_final/).
